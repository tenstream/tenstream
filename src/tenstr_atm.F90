...
!> \page General atmospheric state routines for TenStream
!! Concatenate model input with a background atmosphere profile, providing
!! a merged column that extends from the surface to the top of atmosphere.
!!
