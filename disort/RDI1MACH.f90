...
! ---------------------------------------------------------------------
!  Fortran-90 versions of machine-constant routines R1MACH, D1MACH, I1MA
!
...
!  References:
!  
!  David Gay and Eric Grosse, Comment on Algorithm 528, Bell Labs, Murra
!    Hill, NJ. submitted to ACM Transactions on Mathematical Software,
!    August 1996.
!
! http://www.nsc.liu.se/~boein/ifip/kyoto/workshop-info/proceedings/eina
!    /d1mach.html  (THIS WEB SITE WORKED AS OF APR 2000)
! ----------------------------------------------------------------------
module m_tenstr_disort_rdi1mach
  contains
...
!                sign (B**E)*( (X(1)/B) + ... + (X(T)/B**T) )
!
!     where 0 <= X(I) .LT. B for I=1,...,T; 0 < X(1); and EMIN <= E <= E
!
!     I1MACH(10) = B, the base.
!
!   Single-Precision:
