...
set(USER_Fortran_FLAGS "-cpp -traceback -extend_source -g -sox -no-wrap-margin -fp-model source")
set(USER_Fortran_FLAGS_RELEASE "-O3 -mtune=native")
set(USER_Fortran_FLAGS_DEBUG "-fp-model strict -warn all -fpe0 -O2 -g -check all -check nopointers -check noarg_temp_created ")
