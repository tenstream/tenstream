...
set(USER_Fortran_FLAGS_RELEASE "-fno-range-check -O2 -mtune=native")
set(USER_Fortran_FLAGS_DEBUG   "-fbacktrace -finit-real=nan -Werror -Wall -pedantic -g -pg -fcheck=all -fbounds-check -ffpe-trap=invalid,zero,overflow,underflow")
