...
!     created:   $Date: 2009-05-22 18:22:22 -0400 (Fri, 22 May 2009) $
      ...
      module m_tenstr_rrtmg_sw_spcvrt
...
! ------- Modules -------
      ...
      use m_tenstr_rrsw_vsn, only : hvrspv, hnamspv
      ...
      ! Intermediate arrays to save optical properties for 3D solvers.
      ! need optical depth, single scatter albedo w0 ang asymm. parameter g
      ! as well as solar source term for individual bands
      ! dimensions are [ k_layer, iband ]
      real(kind=ireals),allocatable,dimension(:)   :: tenstr_solsrc
...
! End loop on jb, spectral band
      ...
      end module m_tenstr_rrtmg_sw_spcvrt
