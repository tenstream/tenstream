module m_tenstr_rrtm_lw
    ...
    use parrrtm, only: ngptlw, nbndlw !,naerec,jpb1, jpb2
    use rrtmg_lw_rad, only: rrtmg_lw
!    use rrtmg_lw_spcvrt, only: tenstr_solsrc      
...
contains
    ...
    subroutine tenstream_rrtm_lw(comm, nlay, nxp, nyp, dx, dy, phi0, theta0, albedo, plev, tlay, tsrfc, h2ovmr, o3vmr, co2vmr, ch4vmr, n2ovmr, o2vmr, lwc, reliq, edir,edn,eup,abso, icollapse)
