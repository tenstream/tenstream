module m_py_eddington
  ...
  contains
     ...
     subroutine py_eddington_coeff_zdun(dtau_in,omega_0_in,g_in,mu_0,a11,a12,a13,a23,a33)
       double precision,intent(in) :: dtau_in,g_in,omega_0_in,mu_0
       double precision,intent(out) :: a11,a12,a13,a23,a33
       real(ireals) :: a11i,a12i,a13i,a23i,a33i

       call eddington_coeff_zdun(real(dtau_in, kind=ireals),        &
                                 real(omega_0_in, kind=ireals),     &
                                 real(g_in, kind=ireals),           &
                                 real(mu_0, kind=ireals),           &
                                 a11i,a12i,a13i,a23i,a33i)
