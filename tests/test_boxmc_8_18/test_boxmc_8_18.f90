...
contains
  ...
  subroutine test_boxmc_select_cases_direct_srctopface(this)
    ...
    S_target = [0.00000, 0.41053, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000]
    ...
    S_target = [0.00000, 0.00000, 0.00000, 0.62579, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000]
    call bmc_8_18%get_coeff(comm,bg,src,.True.,phi,theta,vertices,S,T,S_tol,T_tol, inp_atol=atol, inp_rtol=rtol)
    ...
    S_target = [0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.62588, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000]
    call bmc_8_18%get_coeff(comm,bg,src,.True.,phi,theta,vertices,S,T,S_tol,T_tol, inp_atol=atol, inp_rtol=rtol)
    write(msg,*) ' test_boxmc_select_cases_direct_srctopface src='//itoa(src)//' phi='//ftoa(phi)
    call check(S_target,T_target, S,T, msg=msg)
    ...
    S_target = [0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.62588, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000]
    call bmc_8_18%get_coeff(comm,bg,src,.True.,phi,theta,vertices,S,T,S_tol,T_tol, inp_atol=atol, inp_rtol=rtol)
    write(msg,*) ' test_boxmc_select_cases_direct_srctopface src='//itoa(src)//' phi='//ftoa(phi)
    call check(S_target,T_target, S,T, msg=msg)
    ...
    S_target = [0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.62587, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000]
    call bmc_8_18%get_coeff(comm,bg,src,.True.,phi,theta,vertices,S,T,S_tol,T_tol, inp_atol=atol, inp_rtol=rtol)
    write(msg,*) ' test_boxmc_select_cases_direct_srctopface src='//itoa(src)//' phi='//ftoa(phi)
    call check(S_target,T_target, S,T, msg=msg)
  end subroutine
  ...
  subroutine test_boxmc_select_cases_diff_srctopface(this)
    ...
    S_target = [0.00000, 0.96691, 0.00000, 0.00006, 0.00000, 0.00005, 0.00000, 0.00006, 0.00000, 0.00005, 0.00817, 0.00827, 0.00000, 0.00000, 0.00819, 0.00824, 0.00000, 0.00000]
