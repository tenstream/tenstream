...
subroutine test_eddington(this)
    ...
    targ= [0.77855106460434387,        8.2984956871573792E-009,   9.7582138200468863E-003,   5.1463626191620593E-002,  0.81725726426147882,        1.0000000000000000,       0.80617122770826155]
    call calc(inp,out)
    call check_out(inp,out,targ)

    inp = [ 0.1731484532,  0.6180083156, 0.4121485054, 1.00000000000 ]
    targ= [0.85001352568220123,       2.6158207726886692E-002,  1.8420479735352102E-002,  7.3447050483338217E-002, 0.84101275451228208,       1.0000000000000000,      0.89450783360754049]
    call calc(inp,out)
    call check_out(inp,out,targ)

    inp = [ 0.1931012775E-04, 0.4384377003, -0.0000000000E+00,  0.7070999742 ]
    targ= [0.99997467389811490,       3.6386575613389649E-006,  5.9864742811154891E-006,  5.9864869794782480E-006, 0.99997269146543133,       1.0000000000000000,      0.66666695895859496]
    call calc(inp,out)
    call check_out(inp,out,targ)

    inp = [ 4.895462513 , 0.3104626103E-05 , -0.0000000000E+00 , 0.49999997019767761  ] ! resonance case
    targ= [2.0667880575476368E-004,  0.0000000000000000,       7.7215617940279102E-007,  1.6439929979903860E-009,  5.5957078888272847E-005,  1.0000000000000000,      0.66666666666873631]
    call calc(inp,out)
    call check_out(inp,out,targ)

    inp = [ 3.2662250689525390E-011 , 0.99999171495417127 ,       0.0000000000000000  , 0.17364817766693041 ]
    targ= [0.99999999997550049,       2.4499513529008254E-011,  9.4056105052780989E-011,  9.4060580516466263E-011, 0.99999999981190557,       1.0000000000000000,      0.66666733332665362]
    call calc(inp,out)
    call check_out(inp,out,targ)

    inp = [ 2.9317851124478626E-012,   1.0000000000000000  ,      0.0000000000000000 , 0.17364817766693041 ]
    targ= [0.99999999999779732,       2.2026824808563106E-012,  8.4443208651779663E-012,  8.4384068595938508E-012, 0.99999999998311651,       1.0000000000000000,      0.66666733332665362]
    call calc(inp,out)
    call check_out(inp,out,targ)

    inp = [1.93321303E-10,  0.999984443 ,      2.22044605E-16,  0.17364817766693041 ]
    targ= [0.99999999985500665,       1.4499335065920604E-010,  5.5664139018583103E-010,  5.5664738411040951E-010, 0.99999999888670699,      0.99999999999643174,      0.66666733332143324]
    call calc(inp,out)
    call check_out(inp,out,targ)

    inp = [7.89528581E-11,  0.999988437  ,     2.22044605E-16 , 0.17364817766693041 ]
    targ= [0.99999999994077626,       5.9209526170889148E-011,  2.2734076817292897E-010,  2.2733741157516502E-010, 0.99999999954532859,      0.99999999999039879,      0.66666733331934036]
    call calc(inp,out)
    call check_out(inp,out,targ)

    inp = [ 1.3865453490508738E-011 , 0.99999499320987351 , 0.0000000000000000 , 0.17364817766693041 ]
    targ= [0.99999999998959765,       1.0402345651527867E-011,  3.9931125946960987E-011,  3.9926650483275707E-011, 0.99999999992015198,       1.0000000000000000,      0.66666733332665362]
    call calc(inp,out)
    call check_out(inp,out,targ)

    inp = [ 113.59224626216431 , 2.7005225550306174E-008 , 0.0000000000000000  , 0.17364817766693041 ]
    targ= [5.9668583091624293E-076,   0.0000000000000000,        9.6352077372196252E-009,   4.1335735289420085E-024,   7.9392042247169323E-251,   1.0000000000000000,       0.66666666666668450]
    call calc(inp,out)
    call check_out(inp,out,targ)

    inp = [ 1.4503301E-02,  1.5233955E-12,  1.1920928E-07,   1.000000 ]
    targ= [   0.974944890,     0.00000000, 8.45933545E-10,  8.45891468E-10,  0.985601366,       1.00000000,      0.666666687]
    call calc(inp,out)
    call check_out(inp,out,targ)
