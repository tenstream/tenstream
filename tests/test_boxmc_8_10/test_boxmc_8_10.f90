...
contains
  ...
  subroutine test_boxmc_select_cases_diff_srctopface(this)
    ...
    S_target = zero
    S_target = [zero, 0.242562*one, 0.0887225*one, 0.0887225*one, 0.0887225*one, 0.0887225*one, 0.0887225*one, 0.0887225*one, 0.0887225*one, 0.0887225*one]
