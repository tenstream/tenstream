#!/bin/bash
module purge
module load petsc/single-gcc-9
...
for phi in  0 10 70 130 190 230 280
do
for SZA in 0 20 40
#for SZA in 0
do
  #runex "$mpiexec" "res_${phi}_${SZA}_1d.nc                  "  "-theta0 $SZA  -twostr_only"
  #runex "$rayexec" "res_${phi}_${SZA}_rayli_ac.nc            "  "-theta0 $SZA  -pprts_atm_correction $rayli_opt"
  #runex "$mpiexec" "res_${phi}_${SZA}_3_10str.nc             "  "-theta0 $SZA "
  #runex "$mpiexec" "res_${phi}_${SZA}_3_10str_distorted_ac.nc"  "-theta0 $SZA  -pprts_atm_correction -bmc_online"
  #runex "$mpiexec" "res_${phi}_${SZA}_3_10str_gomtrc_ac.nc   "  "-theta0 $SZA  -pprts_atm_correction -pprts_geometric_coeffs -bmc_online"
  runex "$mpiexec" "res_${phi}_${SZA}_3_10str_gomtrc_ac.nc   "  "-theta0 $SZA  -pprts_atm_correction -pprts_geometric_coeffs -bmc_online"
  wait
